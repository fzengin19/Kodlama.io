    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product> 
            {
                ...
                new Product{ProductId=4,CategoryId=1,ProductName="Samsung Laptop",QuantityPerUnit="4 GB Ram",UnitPrice=5000,UnitsInStock=15},
        ...
        //static List<Product> GetProducts(P)
        //{
        //    foreach (var product in products)
        //    {
